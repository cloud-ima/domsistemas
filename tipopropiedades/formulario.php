...
debug_log("=== FORMULARIO TIPOPROPIEDADES ===");
...
if ( $x_flag == 1 ) {
    ...
    $link=conectarse();
    $idz=$_GET["id"] ?? "";
    $ssql = "select * from tipopropiedades where id ='$idz'";
    ...
    <tr>
      <td width="467" height="200" valign="top">
        <table width="461" border="0" cellpadding="2" cellspacing="0">
          <tr><td width="461" align="center"><div align="left"><strong>Tipo de Propiedades</strong></div></td></tr>
