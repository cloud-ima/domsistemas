...
<br>
<table width="527" border="0" align="center" cellpadding="2" cellspacing="2">
  <tr>
...
<table width="527" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr> 
    ...
    <td width="503" background="../cajamenus/menu_04.jpg"><div align="center"><strong><font color="#333333">Especificaci&oacute;n Tipo de Propiedades </font></strong></div></td>
  ...
  <tr> 
    ...
    <td><table width="500" align="center">
        <tr> 
          <td width="492"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="5">
              <tr> 
...
//		  include("../conexion.php");
		  $link=Conectarse(); 
          $result=mysql_query("SELECT * FROM tipo order by nombre",$link); 
          $a=0;
...
?>
				...
				?>
                      ...
                      <td width="54" align="center" bgcolor="<?php echo $color ?>" > 
                        <br /> <div align="center"></div>                        <div align="center"></div> <div align="center"></div></td>
                      <td width="304" align="left" bgcolor="<?php echo $color ?>" ><?php echo $row["nombre"] ?></td>
