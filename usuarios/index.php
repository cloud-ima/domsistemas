...
?>
				...
				?>
                      ...
                      <td width="118" align="center" bgcolor="<?php echo $color ?>" ><?php echo $row["usuario"] ?> 
                        <br /> </td>
                      <td width="211" align="left" bgcolor="<?php echo $color ?>" ><?php echo $row["nombre"] ?>                      </td>
...
<div align="center"><br><?php include ("../footer.php") ?>
</div>
</body>
</html>