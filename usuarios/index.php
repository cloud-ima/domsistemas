...
<table width="692" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr> 
    ...
    <td width="668" background="../cajamenus/menu_04.jpg"><div align="center"><strong><font color="#333333">Usuarios de Sistema </font></strong></div></td>
  ...
  <tr> 
    ...
    <td><table width="653" align="center">
        <tr> 
          <td width="645"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="5">
            ...
            <table width="88%" border="0" cellspacing="0" cellpadding="0">
              <tr> 
                ...
                <td width="23%"><div align="center"><strong>Cuenta</strong></div></td>
                <td width="38%"><div align="center"><strong>Nombre</strong></div></td>
                <td width="33%"><div align="center"><strong>Tipo Usuario </strong></div>                  <div align="center"></div>                  <div align="center"></div></td>
              </tr>
            </table>
		  ...
		  $link=Conectarse(); 
          $result=mysql_query("SELECT * FROM usuarios where usuario <> 'administrador' order by usuario",$link); 
          $a=0;
...
while ($row = mysql_fetch_array($result)){
           ...
           $codsec= $row["tipo"];
           $link=Conectarse();
           $qry = "SELECT * FROM tipousuarios WHERE id='$codsec'";
		   $res = mysql_query($qry);
           $tipous = mysql_result($res, 0, "nombre");
?>
                        </font></td>
                    </tr>
                  </table>
				...
				?>
                      ...
                      <td width="118" align="center" bgcolor="<? echo $color ?>" ><? echo $row["usuario"] ?> 
                        <br /> </td>
                      <td width="211" align="left" bgcolor="<? echo $color ?>" ><? echo $row["nombre"] ?>                      </td>
                      <td width="176" bgcolor="<? echo $color ?>" ><div align="center"><? echo $tipous ?></div>                        <div align="center"></div>                        <div align="center"></div></td>
...
<div align="center"><br><? include ("../footer.php") ?>
</div>
</body>
</html>