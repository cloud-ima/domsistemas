...
<body leftmargin="0" topmargin="0">
  <table width="850" border="0" align="center" cellpadding="0" cellspacing="0">
    ...
    <tr>
      <td>
        <font size="3"><strong>Consulta de Solicitudes Vigentes Canceladas</strong></font>
      </td>
    </tr>
  </table>
        ...
        <table width="527" border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <td width="395" valign="top">
              <form name="form1" method="post" action="list_solicitudes_ok.php">
  ...
  <table width="980" border="0" align="center" cellpadding="0" cellspacing="0">
    ...
    <tr>
      ...
      <td>
        <table width="980" border="0" cellpadding="0" cellspacing="2" bgcolor="#CCCCCC">
          <tr>
            ...
            <td width="130">
              <font color="#000000"><strong>Funcionario</strong></font>
            </td>
            <td width="76">
              ...
              <table width="99%" height="35" border="0" cellpadding="0" cellspacing="0">
                <tr>
                  ...
                  <td width="110" height="35" align="center" bgcolor="<?php echo $color ?>"><?php echo $fechaed;
                                                                                            ?> <br /> </td>
                  <td width="220" bgcolor="<?php echo $color ?>">
                  ...
                  <td width="91" align="right" bgcolor="<?php echo $color ?>"><?php echo number_format($row["total"], 0, ",", ".");
                                                                              ?> </td>
                  <td width="27" bgcolor="<?php echo $color ?>">
                  ...
                  <td width="26" bgcolor="<?php echo $color ?>">
                    <div align="center"><A onclick="MM_openBrWindow('solicitud_completa.php?id=<?php echo $row["id"] . "&rut=" . $row["rut"] ?>','','scrollbars=no,width=650,height=500')"
                        href="javascript:;"><img src="../images/edit_icon.jpg" width="20" height="20" border="0" title="Consultar Solicitud"></a>
                    </div>
                  </td>
                  <td width="19" bgcolor="<?php echo $color ?>">
                    <div align="center">
                      <?php if ($row["responsable"] <> 'NULL'  and $row["responsable"] <> '0') {
                          if ($tipousuario == 1 or $tipousuario == 4) {
                            echo "<a href='$direc' target=_blank ><img src='../images/ok.jpg' width=20 border=0></a>";
                          }
                        }
                      ?>
                    </div>
