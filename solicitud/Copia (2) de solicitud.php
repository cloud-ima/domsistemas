...
if(form1.direccion.value==""){
     alert("Debe Especificar una Direcci�n") 
     form1.direccion.focus()
return false;
}
if(form1.rol.value==""){
     alert("Debe Ingresar N�mero de Rol") 
     form1.rol.focus()
return false;
}
...
if(form1.certificado.value=="10" && form1.dias.value==""){
	  alert("Debe Ingresar los dias para c�lculo de B.N.U.P.")
	  form1.dias.focus()
	  return false;
}
}
 ...
 ?></strong></font></TD>
            ...
            <TR>
              ...
              <TD colspan="3" valign="top" bgColor=#ffffff><input  name="rol" type="text" class=bordecampos id="rol" size="20" maxlength="20" onBlur="showUser(this.value)"> 
                Presione Tab para Validar ROL </TD>
            </TR>
            <TR>
              <TD bgColor=#ffffff>&nbsp;</TD>
              <TD colspan="3" valign="top" bgColor=#ffffff><div class="style3" id="txtHint">Validaci�n del Rol</div></TD>
            </TR>
            <TR> 
