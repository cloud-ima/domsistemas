...
<script language='javascript'>
  function cat_paises()
  {
    catPaises = window.open('buscaroles.php', 'PROPIEDADES', 'width=600,height=600,scrollbars=yes');
  }
</script>
<script type="text/javascript">
...
xmlhttp.open("GET","getrol.php?q="+str,true);
xmlhttp.send();
}
</script>
...
?>
 ...
 ?></strong></font></TD>
            ...
            <TR>
              ...
              <TD colspan="3" valign="top" bgColor=#ffffff><input  name="rol" type="text" class=bordecampos id="rol" size="20" maxlength="20" onBlur="showUser(this.value)"> 
                (<a href='javascript: cat_paises()'><strong>Buscar Rol</strong></a>) --------------- //Presione Tab para Validar ROL </TD>
            </TR>
            <TR>
            ...
            <TR>
              <TD bgColor=#ffffff>&nbsp;</TD>
              <TD colspan="3" valign="top" bgColor=#ffffff><div class="style3" id="txtHint">Validación del Rol</div></TD>
            </TR>
            <TR> 
