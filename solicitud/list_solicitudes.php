...
if ($x_flag == '') {
  ...
  $consultaSQL = "SELECT c.*, r.nombre, r.apellidos, tc.nombre as nombre_certificado, e.nombres as nombre_estado 
                       ...
                       LEFT JOIN tipocertificado tc ON c.idcert = tc.id 
                       LEFT JOIN estado e ON c.estado = e.id 
                       WHERE c.fecha_solicitud = '$fecha_consulta' AND c.estado = 1 
                       ORDER BY c.id DESC";
...
<body leftmargin="0" topmargin="0">
  <table width="850" border="0" align="center" cellpadding="0" cellspacing="0">
    ...
    <tr>
      <td>
        <font size="3"><strong>Consulta de Solicitudes Vigentes</strong></font>
      </td>
    </tr>
  </table>
        ...
        <table width="527" border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <td width="395" valign="top">
              <form name="form1" method="post" action="list_solicitudes.php">
  ...
  <table width="900" border="0" align="center" cellpadding="0" cellspacing="0">
    <tr>
      <td width="13"><IMG height=28 src="../menus/titleleft.jpg"
          width=13></td>
      <td width="871" background="../menus/titlemiddle.jpg"><strong>
          <font color="#FFFFFF">Solicitudes
            Vigentes</font>
        </strong></td>
        ...
        <table width="100%" border="0" cellpadding="0" cellspacing="2" bgcolor="#CCCCCC">
          <tr>
            <td width="96" height="23">
              <div align="center">
                <font color="#000000"><strong>Fecha</strong></font>
              </div>
            </td>
            <td width="197">
              <font color="#000000"><strong>Nombre Solicitante</strong></font>
            </td>
            <td width="236">
              <font color="#000000"><strong>Tipo Solicitud</strong></font>
            </td>
            <td width="118">
              <font color="#000000"><strong>Estado</strong></font>
            </td>
            <td width="98">
              <font color="#000000"><strong>Valor ($)</strong></font>
            </td>
            <td width="112">&nbsp;</td>
          </tr>
        </table>
              ...
              <table width="99%" height="35" border="0" cellpadding="0" cellspacing="0">
                <tr>
                  ...
                  <td width="100" height="35" align="center" bgcolor="<?php echo $color ?>"><?php echo $fechaed;
                                                                                            ?> <br /> </td>
                  <td width="199" bgcolor="<?php echo $color ?>">
                    <font color="#0066CC"><?php echo $nombre; ?></font>
                  </td>
                  <td width="237" bgcolor="<?php echo $color ?>"><?php echo $nombrecerti
                                                                  ?> (<font color="#990000"><?php echo $row["id"] ?></font>)</td>
                  <td width="119" bgcolor="<?php echo $color ?>"><?php echo $nombreestado ?> <?php echo $mensaje ?> </td>
                  <td width="100" align="right" bgcolor="<?php echo $color ?>"><?php echo number_format($row["total"], 0, ",", ".");
                                                                                ?> </td>
                  <td width="52" bgcolor="<?php echo $color ?>">
                    <div align="right"><A onclick="MM_openBrWindow('mostrar_solicitud.php?id=<?php echo $row["id"] . "&rut=" . $row["rut"] ?>','','scrollbars=no,width=650,height=500')"
                        href="javascript:;"><img src="../images/zoom.gif" title="Consultar Solicitud" width="20" border="0"></a></div>
                  </td>
                  <td width="24" bgcolor="<?php echo $color ?>">
                    <div align="center"><a href="solicitud_completa.php?id=<?php echo $row["id"] . "&rut=" . $row["rut"] ?>"><img src="../images/ok.jpg" width="20" height="19" border="0" title="Ingresar Giro"></a>
                    </div>
                  </td>
                  <td width="18" bgcolor="<?php echo $color ?>">
                    <div align="center"><a href="mantenedor_solicitud.php?id=<?php echo $row['id'] . "&param=3"; ?>" class="bot" onClick="if(!confirm('&iquest;Deseas realmente borrar el Registro, ID N&uacute;mero : <?php echo strtolower($row['id']); ?>?'))return false"><img src="images/delete.jpg" alt="Eliminar" width="26" height="26" border="0"></a>
                    </div>
                  <td width="13" bgcolor="<?php echo $color ?>">
                    <div align="center">
