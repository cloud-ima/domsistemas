...
?>
                  ...
                  <tr> 
                    ...
                    <td colspan="2"> <input disabled name="giro" type="text" id="giro" value="<?php echo $giro ?>" size="20"></td>
                  </tr>
                  <tr> 
                    <td bgcolor="#efefef">Fecha del Giro</td>
                    <td colspan="2"><input  disabled name="fgiro" type="text" id="dateArriva2" onClick="popUpCalendar(this, form1.dateArriva2, 'dd-mm-yyyy');" value="<?php echo $gfecha ?>" size="20" maxlength="10"></td>
                  </tr>
                  <tr> 
                    <td bgcolor="#efefef">N&uacute;mero de O.T.</td>
                    <td> <input  disabled name="ot" type="text" id="ot" value="<?php echo $ot ?>" size="20"></td>
