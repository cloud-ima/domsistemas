...
<table width="692" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr> 
    ...
    <td width="668" background="../cajamenus/menu_04.jpg"><div align="center"><strong><font color="#333333">Usos de Suelo </font></strong></div></td>
  ...
  <tr> 
    ...
    <td><table width="653" align="center">
        <tr> 
          <td width="645"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="5">
            ...
            <table width="88%" border="0" cellspacing="0" cellpadding="0">
              <tr> 
                ...
                <td><div align="center"><strong>Descripci&oacute;n del uso del Suelo </strong><strong></strong></div>                  </td>
              </tr>
            </table>
		  ...
		  $link=Conectarse(); 
          $result=mysql_query("SELECT * FROM usos order by nombre",$link); 
          $a=0;
