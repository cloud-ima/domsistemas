...
if ($num_registros == 0){
	     ...
	     while ($row = mysql_fetch_array($rs)){
			  ...
			  if ( $maned <> '' ){
			       $deptoed = ' , Manzana ' . $row["manzana"];
			  }

			  if ( $sitioed <> '' ){
			       $deptoed = ' , Sitio ' . $row["sitio"];
			  }
...
$html = '<span style="text-align:justify;"> En cumplimiento a lo dispuesto en decreto Nr. 5090 del 29 de octubre de 2008 de la Ilustre
 ...
 tiene asignada la numeraci&oacute;n municipal  ' . $numed . ' ' . $deptoed. ' dentro de la poblaci&oacute;n ' . $pobed. ' . $maned . $sitioed . ' se
