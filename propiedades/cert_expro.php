...
$titulo = '<span style="text-align:center;">CERTIFICADO DE EXPROPIACION</span>';
...
$html3 = '<span style="text-align:justify;"> Inserto en la Zona ' . $zonax .' del Plano regulador vigente de la ciudad de Arica, aprobado
 por resoluci&oacute;n Nr. 4 de fecha 03/03/2009, publicado en el diario oficial con fecha 11/07/2009, '. $expox . '. </span>';
...
$pdf->writeHTML($firma3, true, 0, true, true);/*$pdf->MultiCell(100, 0, 'FRANCISCO ZULETA GOMEZ'."\n", 0, 'C', 0, 1, '', '', true, 0);
...
header('Content-Disposition: inline; filename="certificado_expropiacion.pdf"');
