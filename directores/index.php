...
?>
				...
				?>
                      ...
                      <td width="441" align="center" bgcolor="<?php echo $color ?>" ><?php echo $row["nombre"] ?> 
                        <br /> <div align="center"></div>                        <div align="center"></div> <div align="center"></div></td>
                      <td width="17" align="center" bgcolor="<?php echo $color ?>" ><?php if ( $row["activo"] == 'S' ) {
            ...
            href="javascript:;"><img src="../css/modificar.gif" alt="Modificar Ficha" width="17" height="12" border="0"></a></div></td>
                      <td width="42" bgcolor="<?php echo $color ?>"> <div align="center"><a href="mantenedor.php?id=<?php echo $row['id']."&param=3"; ?>"class="bot" onClick="if(!confirm('¿Deseas realmente borrar el Registro, ID Número : <?php echo strtolower($row['id']); ?>?'))return false"><img src="../css/action_stop.gif" title="Eliminar Parámetro" width="16" height="16" border="0"></a></div></td>
                      <td width="43" bgcolor="<?php echo $color ?>"><a href="mantenedor.php?id=<?php echo $row['id']."&param=4"; ?>">Activar</a></td>
                    </tr>
                  </table>
