  ...
  <TBODY>
    ...
    vAlign=center align=left width="473" bgColor=#ffffff 
      height=42>&nbsp;&nbsp;<font color="#333333" size="3" face="Georgia, Times New Roman, Times, serif"><strong>Crear 
        Juntas Vecinales(<? echo $idestado ?>)</strong></font></TD>
      <TD 
...
border=0>
          <TBODY>
            <TR> 
              ...
              <TD width="360" bgColor=#ffffff><input class=bordecampos name="nombre" type="text" id="nombre" value="<? echo $nomz ?>" size="60" maxlength="100"></TD>
            </TR>
            <TR> 
            ...
            <TR> 
              <TD bgColor=#ffffff><input name="param" type="hidden" id="param" value="<? echo $parz ?>"> 
