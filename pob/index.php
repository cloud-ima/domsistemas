...
?>
				...
				?>
                          <td width="31" height="18" align="right" bgcolor="<?php echo $color ?>"><div align="right"><font color="#000000"><?php echo $row["id"] ?></font></div></td>
                          <td align="center" bgcolor="<?php echo $color ?>" > <?php echo $row["nombre"] ?><br />                            <div align="center"></div>                            <div align="center"></div></td>
                          <td width="53" bgcolor="<?php echo $color ?>"><div align="center"></div></td>
                          <td width="33" bgcolor="<?php echo $color ?>"><div align="center"><A onclick="MM_openBrWindow('formulario.php?id=<?php echo $row["id"]. "&flag=1"?>','','scrollbars=yes,width=500,height=290')" 
            href="javascript:;"><img src="../css/modificar.gif" alt="Modificar Ficha" width="17" height="12" border="0"></a></div></td>
                          <td width="34" bgcolor="<?php echo $color ?>"><div align="center"><a href="mantenedor.php?id=<?php echo $row['id']."&param=3"; ?>"class="bot" onClick="if(!confirm('&iquest;Deseas realmente borrar el Registro, ID N&uacute;mero : <?php echo strtolower($row['id']); ?>?'))return false"><img src="../css/action_stop.gif" title="Eliminar Par&aacute;metro" width="16" height="16" border="0"></a></div></td>
                        </tr>
                      </table>
