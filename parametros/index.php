...
?>
				...
				?>
                      ...
                      <td width="118" align="center" bgcolor="<? echo $color ?>" ><? echo $row["desde"] ?> 
                        <br /> </td>
                      <td width="107" align="center" bgcolor="<? echo $color ?>" ><? echo $row["hasta"] ?></td>
                      <td width="93" bgcolor="<? echo $color ?>" ><div align="center"><? echo $row["uf"] ?></div></td>
                      <td width="85" bgcolor="<? echo $color ?>" ><div align="center"><? echo $row["utm"] ?></div></td>
                      <td width="94" bgcolor="<? echo $color ?>"> <div align="center"><? echo $row["cuota"] ?></div></td>
