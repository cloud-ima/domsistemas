          ...
          <td width="645"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="5">
            ...
            <table width="88%" border="0" cellspacing="0" cellpadding="0">
              <tr> 
                ...
                <td width="23%"><div align="center"><strong>Fec. Desde</strong></div></td>
                <td width="19%"><div align="center"><strong>Fec. Hasta</strong></div></td>
                <td width="18%"><div align="center"><strong>U.F.</strong></div></td>
                <td width="16%"><div align="center"><strong>U.T.M.</strong></div></td>
                <td width="18%"><div align="center"><strong>Cuota Ahorro</strong></div></td>
              </tr>
            </table>
...
?>
				...
				?>
                      ...
                      <td width="118" align="center" bgcolor="<?php echo $color ?>" ><?php echo $row["desde"] ?> 
                        <br /> </td>
                      <td width="107" align="center" bgcolor="<?php echo $color ?>" ><?php echo $row["hasta"] ?></td>
                      <td width="93" bgcolor="<?php echo $color ?>" ><div align="center"><?php echo $row["uf"] ?></div></td>
                      <td width="85" bgcolor="<?php echo $color ?>" ><div align="center"><?php echo $row["utm"] ?></div></td>
                      <td width="94" bgcolor="<?php echo $color ?>"> <div align="center"><?php echo $row["cuota"] ?></div></td>
