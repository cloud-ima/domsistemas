...
<table width="692" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr> 
    ...
    <td width="668" background="../cajamenus/menu_04.jpg"><div align="center"><strong><font color="#333333">Destinos</font></strong></div></td>
  ...
  <tr> 
    ...
    <td><table width="653" align="center">
        <tr> 
		  ...
		  $link=Conectarse(); 
          $result=mysql_query("SELECT * FROM destino order by nombre",$link); 
          $a=0;
